...
# Interaktive Analyse der erfassten Belastungsparameter
...
p_Laktat_01 <- plot_ly() %>%
  ...
  add_annotations(text = sprintf("ΔBLC = %.4f · e<sup>(%.5f · ΔP<sub>mech</sub>)</sup>", coef_exponential_model['a'], coef_exponential_model['b']),
