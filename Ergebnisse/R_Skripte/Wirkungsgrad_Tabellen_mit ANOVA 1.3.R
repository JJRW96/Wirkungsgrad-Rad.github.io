...
stats$`Mittelwert ± SD` <- paste(
  case_when(
    stats$Variable %in% c("Wirk_muskulär [%]", "Wirk_Arbeit [%]","Wirk_Brutto [%]", "Wirk_Netto [%]", "Wirk_Total [%]") ~
      sprintf("%.2f ± %.2f", 
...
ft_Wirkungsgrad_stats_mean <- flextable(stats) %>%
  ...
  compose(
    ...
    value = as_paragraph("η", as_sub("Total"), " [%]")
  ) %>% 
  compose(
    j = "Parameter",
  ...
  if(var %in% c("Wirk_muskulär [%]","Wirk_Total [%]", "Wirk_Netto [%]", "Wirk_Brutto [%]")) {  
    ...
    if(normal_dist && var_homogen) {
      ...
      if(var == "Wirk_muskulär [%]" || var == "Wirk_Brutto [%]") {
        ...
        if(var == "Wirk_muskulär [%]") {
          posthoc_ergebnisse_Intensität_Wirk_muskulär <<- list(p.value = wilcox_matrix,
                                                               "Cohen's d" = cohens_d_matrix)
        } else if(var == "Wirk_Brutto [%]") {
          posthoc_ergebnisse_Intensität_Wirk_Brutto <<- list(p.value = wilcox_matrix,
                                                            "Cohen's d" = cohens_d_matrix)
        }
      }
    }
...
ft_Wirkungsgrad_stats_Bedingung_Intensitaet_mean <- flextable(stats) %>%
  ...
  compose(
    ...
    i = 1,
    j = 5,
    value = as_paragraph("Stehen (MW ± SD)", as_sup(" ‡"))
  ) %>%
  compose(
    j = "Variable",
  ...
  add_footer_row(
    values = as_paragraph(
      ...
      as_sup("†"), " : Signifikanter Effekt der Intensität für η", as_sub("muskulär"), " innerhalb der Bedingung Sitzen (p < .05); ",
      as_sup("‡"), " : Signifikanter Effekt der Intensität für η", as_sub("Brutto"), "und η", as_sub("Netto")," innerhalb der Bedingung Stehen (p < .05)\n",
      "η", as_sub("muskulär"), " [%]: muskulärer Wirkungsgrad; ",
      "η", as_sub("Total"), " [%]: Gesamtwirkungsgrad; ",
      "η", as_sub("Arbeit,sitzen"), " [%]: Arbeitswirkungsgrad (sitzende Position); ",
      "η", as_sub("Netto"), " [%]: Nettowirkungsgrad; ",
...
post_hoc_data <- data.frame(
  Vergleich = rownames(posthoc_ergebnisse_sitzen_Bedingung_Intensität_Wirk_muskulär$`Wirk_muskulär [%]`$posthoc),
  Differenz = posthoc_ergebnisse_sitzen_Bedingung_Intensität_Wirk_muskulär$`Wirk_muskulär [%]`$posthoc[, "diff"],
  KI_unten = posthoc_ergebnisse_sitzen_Bedingung_Intensität_Wirk_muskulär$`Wirk_muskulär [%]`$posthoc[, "lwr"],
  KI_oben = posthoc_ergebnisse_sitzen_Bedingung_Intensität_Wirk_muskulär$`Wirk_muskulär [%]`$posthoc[, "upr"],
  p_Wert = posthoc_ergebnisse_sitzen_Bedingung_Intensität_Wirk_muskulär$`Wirk_muskulär [%]`$posthoc[, "p adj"],
  Cohens_d = posthoc_ergebnisse_sitzen_Bedingung_Intensität_Wirk_muskulär$`Wirk_muskulär [%]`$cohens_d$d
)
...
post_hoc_data$p_Wert <- paste0(format(round(post_hoc_data$p_Wert, 3), nsmall = 3),
                               sapply(post_hoc_data$p_Wert, add_significance_symbols))
# Erstellen der Flextable
ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär <- flextable(post_hoc_data) %>%
  set_header_labels(
...
# Setzen der Tabelle auf volle Breite
ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär <- set_table_properties(
  ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär, 
  width = 1, 
  layout = "autofit"
)
...
# Speichern in ...Probanden_Energieberechnung/xlsm
saveRDS(ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär, "C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Daten/Probanden_Energieberechnung/xlsm/ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär.rds")
ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär <- readRDS("C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Daten/Probanden_Energieberechnung/xlsm/ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär.rds")

# Speichern in ...Ergebnisse/rds
saveRDS(ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär, "C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Wirkungsgrad-Rad.github.io/Ergebnisse/rds/ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär.rds")
ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär <- readRDS("C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Wirkungsgrad-Rad.github.io/Ergebnisse/rds/ft_post_hoc_sitzen_Bedingung_Intensität_Wirk_muskulär.rds")


###############################################################################
# Funktion zur Durchführung der ANOVA für einen Wirkungsgradtyp
perform_anova_for_type <- function(data, wirk_type) {
  # Daten für die drei Intensitätsvergleiche vorbereiten
  # Leicht
  data_leicht <- filter(data, Intensität == "leicht") %>%
    mutate(dv = get(paste0("Wirk_", wirk_type, " [%]")) * 100)
  
  # Moderat
  data_moderat <- filter(data, Intensität == "moderat") %>%
    mutate(dv = get(paste0("Wirk_", wirk_type, " [%]")) * 100)
  
  # Schwer
  data_schwer <- filter(data, Intensität == "schwer") %>%
    mutate(dv = get(paste0("Wirk_", wirk_type, " [%]")) * 100)
...
# Liste der Wirkungsgradtypen
wirk_types <- c("muskulär", "Total", "Netto", "Brutto")

# Durchführung der Analysen für jeden Wirkungsgradtyp
anova_results_list <- lapply(wirk_types, function(type) {
  perform_anova_for_type(Bedingungen_data_Wirkungsgrad, type)
})

# Zusammenführen aller Ergebnisse
anova_results_combined <- do.call(rbind, anova_results_list)

# Optional: Ausgabe der Ergebnisse
print(anova_results_combined)

# Zusätzlich können Sie die Einzelergebnisse separat speichern
anova_results_Wirk_muskulär <- anova_results_list[[1]]
anova_results_Wirk_Total <- anova_results_list[[2]]
anova_results_Wirk_Netto <- anova_results_list[[3]]
anova_results_Wirk_Brutto <- anova_results_list[[4]]
...
##### Post-hoc für Intensitäten und Wirk_Brutto #####
# Post-hoc Daten mit Cohen's d
post_hoc_data_Stehen_Wirk_Brutto<- data.frame(
  Vergleich = rownames(posthoc_ergebnisse_Stehen_Intensität_Wirk_Brutto$Intensität),
  Differenz = posthoc_ergebnisse_Stehen_Intensität_Wirk_Brutto$Intensität[, "diff"],
  KI_unten = posthoc_ergebnisse_Stehen_Intensität_Wirk_Brutto$Intensität[, "lwr"],
  KI_oben = posthoc_ergebnisse_Stehen_Intensität_Wirk_Brutto$Intensität[, "upr"],
  p_Wert = posthoc_ergebnisse_Stehen_Intensität_Wirk_Brutto$Intensität[, "p adj"],
  Cohens_d = posthoc_ergebnisse_Stehen_Intensität_Wirk_Brutto$Intensität[, "Cohen's d"]
)

# Neuordnung und Formatierung
post_hoc_data_Stehen_Wirk_Brutto<- post_hoc_data_Stehen_Wirk_Brutto[c(2, 1, 3), ]
post_hoc_data_Stehen_Wirk_Brutto$Vergleich <- gsub("moderat", "Moderat", post_hoc_data_Stehen_Wirk_Brutto$Vergleich)
post_hoc_data_Stehen_Wirk_Brutto$Vergleich <- gsub("leicht", "Leicht", post_hoc_data_Stehen_Wirk_Brutto$Vergleich)
post_hoc_data_Stehen_Wirk_Brutto$Vergleich <- gsub("schwer", "Schwer", post_hoc_data_Stehen_Wirk_Brutto$Vergleich)
...
# Signifikanzsymbole hinzufügen
post_hoc_data_Stehen_Wirk_Brutto$p_Wert <- paste0(format(round(post_hoc_data_Stehen_Wirk_Brutto$p_Wert, 3), nsmall = 3),
                                           sapply(post_hoc_data_Stehen_Wirk_Brutto$p_Wert, add_significance_symbols))

# Direkte Ausgabe der Post-hoc-Ergebnisse
cat("\nErgebnisse des Post-hoc-Tests:\n")
cat("----------------------------\n")

for(i in 1:nrow(post_hoc_data_Stehen_Wirk_Brutto)) {
  p_val <- as.numeric(sub("[*]+$", "", post_hoc_data_Stehen_Wirk_Brutto$p_Wert[i]))
  sig_level <- if(p_val < 0.05) "signifikant" else "nicht signifikant"
  
  cat(sprintf("%s:\n", post_hoc_data_Stehen_Wirk_Brutto$Vergleich[i]))
  cat(sprintf("  Mittlere Differenz: %.2f\n", post_hoc_data_Stehen_Wirk_Brutto$Differenz[i]))
  cat(sprintf("  p-Wert: %s (%s)\n", post_hoc_data_Stehen_Wirk_Brutto$p_Wert[i], sig_level))
  cat("----------------------------\n")
}


# Erstellen der Flextable
ft_post_hoc_Stehen_Wirk_Brutto <- flextable(post_hoc_data_Stehen_Wirk_Brutto) %>%
  set_header_labels(
    Vergleich = " ",
    Differenz = "Mittlere Differenz",
    KI_unten = "95% KI Untergrenze",
  ...
  compose(
    part = "header",  
    i = 1, j = "Vergleich",
    value = as_paragraph("Stehen: Post-hoc Vergleich von ", "η", as_sub("Brutto"))
  ) %>%
  theme_zebra(
    odd_header = "grey92",
    even_header = "grey92",
...
# Setzen der Tabelle auf volle Breite
ft_post_hoc_Stehen_Wirk_Brutto <- set_table_properties(
...
# Speichern in ...Probanden_Energieberechnung/xlsm
saveRDS(ft_post_hoc_Stehen_Wirk_Brutto, "C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Daten/Probanden_Energieberechnung/xlsm/ft_post_hoc_Stehen_Wirk_Brutto.rds")
ft_post_hoc_Stehen_Wirk_Brutto <- readRDS("C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Daten/Probanden_Energieberechnung/xlsm/ft_post_hoc_Stehen_Wirk_Brutto.rds")

# Speichern in ...Ergebnisse/rds
saveRDS(ft_post_hoc_Stehen_Wirk_Brutto, "C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Wirkungsgrad-Rad.github.io/Ergebnisse/rds/ft_post_hoc_Stehen_Wirk_Brutto.rds")
ft_post_hoc_Stehen_Wirk_Brutto <- readRDS("C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Wirkungsgrad-Rad.github.io/Ergebnisse/rds/ft_post_hoc_Stehen_Wirk_Brutto.rds")

########################################################################################
##### Post-hoc für Intensitäten und Wirk_Netto #####
# Post-hoc Daten mit Cohen's d
post_hoc_data_Stehen_Wirk_Netto <- data.frame(
  Vergleich = rownames(posthoc_ergebnisse_Stehen_Intensität_Wirk_Netto$Intensität),
  Differenz = posthoc_ergebnisse_Stehen_Intensität_Wirk_Netto$Intensität[, "diff"],
  KI_unten = posthoc_ergebnisse_Stehen_Intensität_Wirk_Netto$Intensität[, "lwr"],
  KI_oben = posthoc_ergebnisse_Stehen_Intensität_Wirk_Netto$Intensität[, "upr"],
  p_Wert = posthoc_ergebnisse_Stehen_Intensität_Wirk_Netto$Intensität[, "p adj"],
  Cohens_d = posthoc_ergebnisse_Stehen_Intensität_Wirk_Netto$Intensität[, "Cohen's d"]
)

# Neuordnung und Formatierung
post_hoc_data_Stehen_Wirk_Netto <- post_hoc_data_Stehen_Wirk_Netto [c(2, 1, 3), ]
post_hoc_data_Stehen_Wirk_Netto$Vergleich <- gsub("moderat", "Moderat", post_hoc_data_Stehen_Wirk_Netto$Vergleich)
post_hoc_data_Stehen_Wirk_Netto$Vergleich <- gsub("leicht", "Leicht", post_hoc_data_Stehen_Wirk_Netto$Vergleich)
post_hoc_data_Stehen_Wirk_Netto$Vergleich <- gsub("schwer", "Schwer", post_hoc_data_Stehen_Wirk_Netto$Vergleich)
...
# Signifikanzsymbole hinzufügen
post_hoc_data_Stehen_Wirk_Netto$p_Wert <- paste0(format(round(post_hoc_data_Stehen_Wirk_Netto$p_Wert, 3), nsmall = 3),
                                                  sapply(post_hoc_data_Stehen_Wirk_Netto$p_Wert, add_significance_symbols))

# Direkte Ausgabe der Post-hoc-Ergebnisse
cat("\nErgebnisse des Post-hoc-Tests:\n")
cat("----------------------------\n")

for(i in 1:nrow(post_hoc_data_Stehen_Wirk_Netto)) {
  p_val <- as.numeric(sub("[*]+$", "", post_hoc_data_Stehen_Wirk_Netto$p_Wert[i]))
  sig_level <- if(p_val < 0.05) "signifikant" else "nicht signifikant"
  
  cat(sprintf("%s:\n", post_hoc_data_Stehen_Wirk_Netto$Vergleich[i]))
  cat(sprintf("  Mittlere Differenz: %.2f\n", post_hoc_data_Stehen_Wirk_Netto$Differenz[i]))
  cat(sprintf("  p-Wert: %s (%s)\n", post_hoc_data_Stehen_Wirk_Netto$p_Wert[i], sig_level))
  cat("----------------------------\n")
}


# Erstellen der Flextable
ft_post_hoc_Stehen_Wirk_Netto <- flextable(post_hoc_data_Stehen_Wirk_Netto) %>%
  set_header_labels(
    Vergleich = " ",
    Differenz = "Mittlere Differenz",
    KI_unten = "95% KI Untergrenze",
  ...
  compose(
    part = "header",  
    i = 1, j = "Vergleich",
    value = as_paragraph("Stehen: Post-hoc Vergleich von ", "η", as_sub("Netto"))
  ) %>%
  theme_zebra(
    odd_header = "grey92",
    even_header = "grey92",
...
# Setzen der Tabelle auf volle Breite
ft_post_hoc_Stehen_Wirk_Netto <- set_table_properties(
...
# Speichern in ...Probanden_Energieberechnung/xlsm
saveRDS(ft_post_hoc_Stehen_Wirk_Netto, "C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Daten/Probanden_Energieberechnung/xlsm/ft_post_hoc_Stehen_Wirk_Netto.rds")
ft_post_hoc_Stehen_Wirk_Netto <- readRDS("C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Daten/Probanden_Energieberechnung/xlsm/ft_post_hoc_Stehen_Wirk_Netto.rds")

# Speichern in ...Ergebnisse/rds
saveRDS(ft_post_hoc_Stehen_Wirk_Netto, "C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Wirkungsgrad-Rad.github.io/Ergebnisse/rds/ft_post_hoc_Stehen_Wirk_Netto.rds")
ft_post_hoc_Stehen_Wirk_Netto <- readRDS("C:/Users/johan/OneDrive/Desktop/SpoWi/WS 22,23/Masterarbeit - Wirkungsgrad/Wirkungsgrad-Rad.github.io/Ergebnisse/rds/ft_post_hoc_Stehen_Wirk_Netto.rds")
