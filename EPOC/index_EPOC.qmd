...
Um den Verlauf von $\dot{V}O_{2EPOC}$ so zu simulieren, wie er unter simulierten Ruhebedingungen verlaufen wäre, wurde angenommen, dass $\dot{V}O_{2EPOC}$ spätestens 60 Minuten nach Beendigung der Belastung auf das Niveau von $\dot{V}O_{2Ruhe}$ zurückkehren sollte. Außerdem wird angenommen, dass die der schnelle initiale Abfall die $\dot{V}O_{2EPOC, \text{fast}}$ repräsentiert.
