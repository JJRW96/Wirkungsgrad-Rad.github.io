...
Nach gleicher Vorgehensweise kann man auch das kalorische Äquivalent des Sauerstoffs (kÄ~FETT~) für Fettsäureverbrennung näherungsweise bestimmen. Je nach oxidierter Fettsäuren liegt der RQ zwischen 0,69 und 0,73 [@McArdle2009, 186]. Für die Palmitinsäure lautet die Summenformel (C~16~H~32~O~2~) und die stöchiometrische Gleichung:
