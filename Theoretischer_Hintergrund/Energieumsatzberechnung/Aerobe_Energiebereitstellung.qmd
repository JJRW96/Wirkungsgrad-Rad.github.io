...
Nachdem man h bestimmt hat, kann man mit dem Umrechnungsfaktor von 4,1868 den Wert in kJ mrechnen und auf einen zeitraum von einer Munute umrechnen. Mithilfe des gemessenen RQ welcher für jeden Proband individuell für den Ruhezeitraum bestimmt wurde konnte das kalorischen Äquivalents (kÄ) anhand von @tbl-stegemann bestimmt werden und der ermittelte Wärmewert in liter pro Minute umgerechnet werden.

Da die bestimmte Basalrate nach @Harris1918 für den RUhezustand im liegen bestimmt wurde, muss dies noch auf den Ruhewert im Sitzen übertragen werden, dazu  multiplizieren wir die Ruhewerte h~f, m~ mit dem Faktor $\frac{1.39}{1.08} = 1.287$ für Männer und $\frac{1.15}{0.90} = 1.278$ für Frauen auf Basis von @fig-CIBA_GEIGY [@Ciba-Geigy1977, 225].
...
::: {.column width="48%"}
> Beispielrechnung für RMR:
> Gewicht = 75kg, Körperhöhe = 180, Alter = 25 Jahre, RQ = 0.77
:::
:::
