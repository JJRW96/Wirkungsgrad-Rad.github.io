...
Innere Arbeit, auch bekannt als Blind- oder Leerleistung, spielt eine zentrale Rolle bei zyklischen Bewegungen wie dem Radfahren. Sie resultiert aus der erforderlichen Rotation und Verschiebung der Gliedmaßenschwerpunkte, was unerlässlich für die Aufrechterhaltung der Gesamtkörperbalance ist. Nach @Sjøgaard2002 ist sie definiert als die Leistung, die aufgebracht werden muss, um die Trägheits- und Gravitationskräfte der bewegten Gliedmaßen zu überwinden. Wie @Minetti1998 hervorhebt, ist dieses Konzept besonders relevant bei symmetrischen Bewegungen wie dem Radfahren, wo sich die Gliedmaßen quasi-symmetrisch zum Körperschwerpunkt bewegen. Die innere Arbeit, obwohl sie keine externen vortriebswirksamen Kräfte erzeugt, ist für die kontinuierliche Bewegung entscheidend und unterscheidet sich damit von der externen Arbeit, die für den direkten Vortrieb verantwortlich ist.

Im Rahmen der Radfahrbewegung bewegen sich Beine und Gliedmaßen entlang eines spezifischen Pfades und benötigen dafür Energie, um diese Bewegung aufrechtzuerhalten. Nach @Winter1979 setzt sich diese Energie aus der potentiellen Energie (PE), der translatorischen kinetischen Energie (TKE) und der rotatorischen kinetischen Energie (RKE) aller bewegten Segmente zusammen. @Minetti2001 zeigten, dass die innere Arbeit beim Radfahren stark von der Geometrie und Masseverteilung der Gliedmaßen sowie der gewählten Tretfrequenz abhängt. Aus physikalischer Perspektive entsteht dabei bei einem vollständigen Bewegungszyklus keine Nettoarbeit, da Anfangs- und Endpositionen gleich sind. Diese muskuläre Leistung reflektiert die innere Arbeit, die, obwohl ohne direkten Beitrag zum Vortrieb, für die Bewegungsdynamik essentiell ist. Während eines Bewegungszyklus findet dabei ein kontinuierlicher Energieaustausch sowohl zwischen diesen Energieformen innerhalb eines Segments als auch zwischen verschiedenen Segmenten statt.

Verschiedene Faktoren beeinflussen diese innere Arbeit und führen insbesondere bei hohen Trittraten zu einer Zunahme der metabolischen Kosten. @Tokui2007 zeigten, dass die innere Leistung exponentiell mit der Trittfrequenz ansteigt und bei 120 U/min bis zu 90 Watt betragen kann. Die metabolischen Kosten steigen nach @Francescato1995 sogar mit der 4,165ten Potenz der Trittrate. Diese Faktoren umfassen die durch die Hill-Gleichung beschriebene verminderte Kraftproduktion der Muskeln bei hoher Kontraktionsgeschwindigkeit, die gleichzeitige Aktivierung von Agonisten und Antagonisten – was zu einem erhöhten Abbremsen der Streckbewegung der unteren Extremität führt – und den Reibungs- sowie Viskositätswiderstand von Gelenkknorpel, Bändern und anderen bewegungsunterstützenden Strukturen. Nach @Minetti1998 ist dabei besonders die Anpassung der Bewegungsmuster bei unterschiedlichen Geschwindigkeiten zu berücksichtigen, da diese die Effizienz der Bewegung maßgeblich beeinflusst. @Bell2009 weisen zusätzlich auf die vermehrte Aktivierung von Ca2+-ATPasen für nicht-kontraktile Prozesse und eine verstärkte Rekrutierung von Typ-II-Muskelfasern hin, die eine geringere Effizienz aufweisen.

Durch eine detaillierte Betrachtung dieser Prozesse – das Erfassen aller Energiebeiträge entlang des Bewegungsverlaufs – erhalten wir ein umfassendes Verständnis der energetischen Anforderungen der Bewegung. Bei moderaten Belastungen (100W) und mittleren Trittfrequenzen (60 U/min) beträgt der Anteil der inneren Arbeit etwa 20% des Gesamtenergieumsatzes (@Francescato1995). @Minetti2001 zeigten zudem, dass die Evolution des Fahrraddesigns zu einer stetigen Optimierung dieses Energieverhältnisses führte.


Für die Quantifizierung der inneren Arbeit haben sich verschiedene methodische Ansätze etabliert: (1) Biomechanische Modelle wie von @Winter1979, die alle Segmentbewegungen und deren Energiekomponenten (PE, TKE, RKE) erfassen und den Energieaustausch zwischen Segmenten berücksichtigen. (2) Vereinfachte kinematische Modelle speziell fürs Radfahren wie von @Minetti2001 (Pint = 0.153 * BM * f^3), die die innere Leistung aus Körpermasse und Trittfrequenz berechnen. @Minetti1998 erweiterte diesen Ansatz durch Einbeziehung des "duty factors", der das Verhältnis von Stand- zu Schwungphase beschreibt. (3) Metabolische Ansätze wie von @Francescato1995, die die innere Arbeit aus der Sauerstoffaufnahme bei verschiedenen Belastungen und Frequenzen ableiten. (4) Kombinierte Ansätze wie von @Sjøgaard2002, die biomechanische Modelle durch metabolische Messungen (Sauerstoffaufnahme, Muskeldurchblutung) validieren. (5) Der in dieser Arbeit verwendete Ansatz basiert auf dem biomechanischen Modell von Winter, wurde aber spezifisch für das Radfahren adaptiert. Dabei werden die translatorischen und rotatorischen kinetischen Energien für Ober- und Unterschenkelsegmente sowie die Fahrradkurbel berechnet und deren Änderungen über den Bewegungszyklus analysiert. Zusätzlich berücksichtigt das Modell die Phasenverschiebung zwischen rechtem und linkem Bein und verwendet moderne Datenverarbeitungsmethoden zur Ausreißererkennung und Glättung. Diese Weiterentwicklung ermöglicht eine präzise zeitaufgelöste Analyse der inneren Arbeit während des Radsports.
