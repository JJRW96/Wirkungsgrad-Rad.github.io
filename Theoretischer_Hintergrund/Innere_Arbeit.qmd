...
Innere Arbeit, auch bekannt als Blind- oder Leerleistung, spielt eine zentrale Rolle bei zyklischen Bewegungen wie dem Radfahren. Sie resultiert aus der erforderlichen Rotation und Verschiebung der Gliedmaßenschwerpunkte, was unerlässlich für die Aufrechterhaltung der Gesamtkörperbalance ist. Nach Sjøgaard et al. (2002) ist sie definiert als die Leistung, die aufgebracht werden muss, um die Trägheits- und Gravitationskräfte der bewegten Gliedmaßen zu überwinden. Die Innere Arbeit, obwohl sie keine externen vortriebswirksamen Kräfte erzeugt, ist für die kontinuierliche Bewegung entscheidend und unterscheidet sich damit von der externen Arbeit, die für den direkten Vortrieb verantwortlich ist.

Im Rahmen der Radfahrbewegung bewegen sich Beine und Gliedmaßen entlang eines spezifischen Pfades und benötigen dafür einen Energieumsatz Energie, um diese Bewegung aufrechtzuerhalten. Nach Winter (1979) setzt sich diese Energie aus der potentiellen Energie (PE), der translatorischen kinetischen Energie (TKE) und der rotatorischen kinetischen Energie (RKE) aller bewegten Segmente zusammen. Aus physikalischer Perspektive entsteht dabei bei einem vollständigen Bewegungszyklus keine Nettoarbeit, da Anfangs- und Endpositionen gleich sind. Diese muskuläre Leistung reflektiert die innere Arbeit, die, obwohl ohne direkten Beitrag zum Vortrieb, für die Bewegungsdynamik essentiell ist. Während eines Bewegungszyklus findet dabei ein kontinuierlicher Energieaustausch sowohl zwischen diesen Energieformen innerhalb eines Segments als auch zwischen verschiedenen Segmenten statt.

Verschiedene Faktoren beeinflussen diese innere Arbeit und führen insbesondere bei hohen Trittraten zu einer Zunahme der metabolischen Kosten. Tokui & Hirakoba (2007) zeigten, dass die innere Leistung exponentiell mit der Trittfrequenz ansteigt und bei 120 U/min bis zu 90 Watt betragen kann. Die metabolischen Kosten steigen nach Francescato et al. (1995) sogar mit der 4,165ten Potenz der Trittfrequenz. Diese Faktoren umfassen die durch die Hill-Gleichung beschriebene verminderte Kraftproduktion der Muskeln bei hoher Kontraktionsgeschwindigkeit, die gleichzeitige Aktivierung von Agonisten und Antagonisten – was zu einem erhöhten Abbremsen der Streckbewegung der unteren Extremität führt – und den Reibungs- sowie Viskositätswiderstand von Gelenkknorpel, Bändern und anderen bewegungsunterstützenden Strukturen. Bell & Ferguson (2009) weisen zusätzlich auf die vermehrte Aktivierung von Ca2+-ATPasen für nicht-kontraktile Prozesse und eine verstärkte Rekrutierung von Typ-II-Muskelfasern hin, die eine geringere Effizienz aufweisen. Insbesondere das verstärkte Abbremsen der Streckbewegung bei hohen Drehraten, verbunden mit einer höheren muskulären Leistung der Antagonisten, führt zu hohen Blindleistungen.

Durch eine detaillierte Betrachtung dieser Prozesse – das Erfassen aller Energiebeiträge entlang des Bewegungsverlaufs – erhalten wir ein umfassendes Verständnis der energetischen Anforderungen der Bewegung. Bei moderaten Belastungen (100W) und mittleren Trittfrequenzen (60 U/min) beträgt der Anteil der inneren Arbeit etwa 20% des Gesamtenergieumsatzes (Francescato et al., 1995). Diese Analyse ähnelt der Betrachtung der mechanischen Arbeit über einen gesamten Pedalzyklus und veranschaulicht, wie trotz der Abwesenheit von Nettoarbeit Energie für die Aufrechterhaltung der Bewegung eingesetzt wird.

Für die Quantifizierung der inneren Arbeit haben sich verschiedene methodische Ansätze etabliert: (1) Biomechanische Modelle wie von Winter (1979), die alle Segmentbewegungen und deren Energiekomponenten (PE, TKE, RKE) erfassen und den Energieaustausch zwischen Segmenten berücksichtigen. (2) Vereinfachte kinematische Modelle speziell fürs Radfahren wie von Minetti (Pint = 0.153 * BM * f^3), die die innere Leistung aus Körpermasse und Trittfrequenz berechnen. (3) Metabolische Ansätze wie von Francescato et al. (1995), die die innere Arbeit aus der Sauerstoffaufnahme bei verschiedenen Belastungen und Frequenzen ableiten. (4) Kombinierte Ansätze wie von Sjøgaard et al. (2002), die biomechanische Modelle durch metabolische Messungen (Sauerstoffaufnahme, Muskeldurchblutung) validieren.
