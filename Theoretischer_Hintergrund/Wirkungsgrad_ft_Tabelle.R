...
#"Dickenson 1929\nWhipp & Wassermann 1969\nGrowden1950\nHenry & deMoor 1950\nAstrand1952\nMichael et al. 1961\nBanister & Jackson 1967\nRode & Shephard 1973\nKaneko et al. 1979\nSuzuki 1979\nCoast & Welch 1985\nEricson 1988",
...
data <- data.frame(
  Autoren = c(
    ...
    "Harnish et al. (2007)",
    "Millet et al. (2002)",
    "Berkemeier et al. (2020)",
    "Carlsson et al. (2024)",
    "Arkesteijn et al. (2016)",
    "Bouillod et al. (2014)",
    "Dunst et al. (2023)",
    "Zoladz et al. (2023)",
  ...
  Belastungsintensitaet = c(
    ...
    "50% | 65% | 75% | 93% des PPO", 
    "75% des PPO\nBelastungsdauer: 6 min",
    "Sub-anaerobe Schwelle\nBelastungsdauer: 6-8 min\nSteigung 8%",
    "≈ 284W (aerobe Schwelle)\nBelastungsdauer: 5 min\nSteigung 6.8°",
    "50% und 70% MAP\nBelastungsdauer: 5 min\nSteigung 4% und 8%",
    "3.8 | 4.2 | 4.6 [W·kg⁻¹]",
  ...
  Teilnehmende = c(
    ...
    "N = 7 | 21.6 ± 3.8 Jahre | \u2642\nLN: 2; Sportartfremd: Rugby \nV̇O₂ₘₐₓ = 51.34 ± 9.44 [l·min⁻¹·kg⁻¹]",
    "N = 16 (8 jung / 8 alt) | 19-74 Jahre | \u2640\n",
    "N = 8 | 25.8 ± 7.2 Jahre | 7\u2642 1\u2640\nLN: 4-5\nV̇O₂ₘₐₓ = 68.8 ± 5.0 [l·min⁻¹·kg⁻¹]",
    "N = 8 | 20.7 ± 3.9 Jahre | \u2642",
    "N = 9 | 28 ± 7 Jahre | \u2642\nLN: Elite\nV̇O₂ₘₐₓ = 62.7 ± 7.7 [l·min⁻¹·kg⁻¹]",
    "N = 10 | 25 ± 8 Jahre | \u2642\nLN: Elite-National",
    "N = 10 | 31 ± 9 Jahre | \u2642\nLN: Elite\nMAP = 367 ± 40 [Watt]\nV̇O₂peak = 4.8 ± 0.4 [l·min⁻¹]",
    "N = 13\nLN: Elite",
    "N = 12 | Elite-Bahnradsportler\n3♀: 18.7 ± 4.7 Jahre\n9\u2642: 22.2 ± 4.4 Jahre",
    "N = 17 | 23 ± 3 Jahre | \u2642\nV̇O₂max = 3.79 ± 0.40 [l·min⁻¹]",
...
ft_Wirkungsgrad <- flextable(data_sorted) %>%
  ...
  compose(
    ...
    value = as_paragraph(
      ...
      "→ Im Sitzen sig. höherer höherer η"
    )
  ) %>%
  compose(
    j = "Wirkungsgrad",
  ...
  compose(
    ...
    i = 12, # Dunst
    value = as_paragraph(
      "η", as_sub("opt"), " ≈ 16% (Start) → 58% (Ende)\n",
      "η", as_sub("brutto"), " ≈ 10% (3s) → 18.4% (60s)"
    )
  ) %>%
  compose(
    j = "Wirkungsgrad",
    i = 13, # Zoladz
    value = as_paragraph(
      "η", as_sub("brutto"), " = 11.6% (30W) → 21.4% (120W)\n",
  ...
  compose(
    ...
    i = 14, # Carlsson
    value = as_paragraph(
      "η", as_sub("brutto"), " = 21.3 ± 1.2 (Seated)\n",
      "η", as_sub("brutto"), " = 21.3 ± 1.1 (Standing)\n",
      "η", as_sub("brutto"), " = 21.0 ± 1.1 (Transitions)\n",
      "→ Keine Unterschiede zwischen Positionen"
    )
  ) %>%
